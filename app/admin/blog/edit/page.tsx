...
const BlogRegister = () => {
  ...
  useEffect(() => {
    // Set the form values when blogData is updated
    if (!initialLoading && blogData && !formInitialized) {
      form.setValues({
        name: blogData.name || '',
        location: blogData.location || '',
        contactInformation: contactInfomation || {},
        vision: blogData.vision || '',
        focusAreas: blogData.focusAreas || [],
        ...
        license: blogData.license || '',
        funding: blogData.funding || '',
      });
      setFormInitialized(true);
    }
  }, [blogData, initialLoading, formInitialized]);
        ...
        <Stepper active={active} breakpoint="sm">
          <Stepper.Step mt={20} label="First step" description="Blog details">
            ...
            <MultiSelect
              ...
              onChange={(value) =>
                form.setFieldValue('tags', JSON.stringify(value))
              }
            />
            <TextInput
