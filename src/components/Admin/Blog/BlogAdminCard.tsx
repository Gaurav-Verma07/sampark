...
export default function BlogAdminCard(props: DeleteCardType) {
  const { _id, name, content, author, image }: BlogCardType = props.blog;
  ...
  return (
    <>
      ...
      <Modal opened={opened} onClose={close} title="Blog Delete" centered>
        <div style={{ textAlign: 'center' }}>
